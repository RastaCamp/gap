...
export async function queryData(
  env: WorkerEnv,
  params: { q?: string; source?: string; report_type?: string; state?: string; page?: number; per_page?: number }
  ...
  if (params.report_type) {
    conditions.push("reports.report_type = ?");
    args.push(params.report_type);
  }
  if (params.state) {
